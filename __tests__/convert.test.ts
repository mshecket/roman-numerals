...
describe('Catching invalid input', () => {
  ...
  test('A bogus input containing valid Roman numeral characters should return an error', () => {
    expect(convert('VX')).toBe('error');
  });
  test('Another bogus input containing valid Roman numeral characters should return an error', () => {
    expect(convert('IIIIM')).toBe('error');
  });
  test('Yet another bogus input containing valid Roman numeral characters should return an error', () => {
    expect(convert('IVIVIV')).toBe('error');
  });
  test('An input that is just a bunch of Is should return an error', () => {
    expect(convert('IIIIIIII')).toBe('error');
  });
  test('The input XXXX should return an error', () => {
    expect(convert('XXXX')).toBe('error');
  });
  test('The input VIV should return an error', () => {
    expect(convert('VIV')).toBe('error');
  });
  test('The input IVX should return an error', () => {
    expect(convert('IVX')).toBe('error');
  });
  test('The input XCM should return an error', () => {
    expect(convert('XCM')).toBe('error');
  });
  test('The input CCCC should return an error', () => {
    expect(convert('CCCC')).toBe('error');
  });
  test('The input CDC should return an error', () => {
    expect(convert('CDC')).toBe('error');
  });
});
